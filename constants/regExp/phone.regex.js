export const PHONE_COUNTRIES = [
  { locale: "am-AM", iso2: "AM", validation: /^(\+?374|0)((10|[9|7][0-9])\d{6}$|[2-4]\d{7}$)/ },
  ...
  { locale: "be-BY", iso2: "BY", validation: /^(\+?375)?(24|25|29|33|44)\d{7}$/ },
  { locale: "bg-BG", iso2: "BG", validation: /^(\+?359|0)?8[789]\d{7}$/ },
  { locale: "bn-BD", iso2: "BD", validation: /^(\+?880|0)1[13456789][0-9]{8}$/ },
  { locale: "cs-CZ", iso2: "CZ", validation: /^(\+?420)? ?[1-9][0-9]{2} ?[0-9]{3} ?[0-9]{3}$/ },
  { locale: "da-DK", iso2: "DK", validation: /^(\+?45)?\s?\d{2}\s?\d{2}\s?\d{2}\s?\d{2}$/ },
  { locale: "de-DE", iso2: "DE", validation: /^(\+49)?0?1(5[0-25-9]\d|6([23]|0\d?)|7([0-57-9]|6\d))\d{7}$/ },
  ...
  { locale: "en-GH", iso2: "GH", validation: /^(\+233|0)(20|50|24|54|27|57|26|56|23|28)\d{7}$/ },
  { locale: "en-HK", iso2: "HK", validation: /^(\+?852[-\s]?)?[456789]\d{3}[-\s]?\d{4}$/ },
  { locale: "en-MO", iso2: "MO", validation: /^(\+?853[-\s]?)?[6]\d{3}[-\s]?\d{4}$/ },
  { locale: "en-IE", iso2: "IE", validation: /^(\+?353|0)8[356789]\d{7}$/ },
  { locale: "en-IN", iso2: "IN", validation: /^(\+?91|0){1,2}?[6789]\d{9}$/ },
  { locale: "en-KE", iso2: "KE", validation: /^(\+?254|0)(7|1)\d{8}$/ },
  { locale: "en-MT", iso2: "MT", validation: /^(\+?356|0)?(99|79|77|21|27|22|25)[0-9]{6}$/ },
  ...
  { locale: "en-PK", iso2: "PK", validation: /^((\+92)|(0092))-{0,1}\d{3}-{0,1}\d{7}$|^\d{11}$|^\d{4}-\d{7}$/ },
  { locale: "en-RW", iso2: "RW", validation: /^(\+?250|0)?[7]\d{8}$/ },
  { locale: "en-SG", iso2: "SG", validation: /^(\+65)?[89]\d{7}$/ },
  { locale: "en-SL", iso2: "SL", validation: /^(?:0|94|\+94)?(7(0|1|2|5|6|7|8)( |-)?\d)\d{6}$/ },
  { locale: "en-TZ", iso2: "TZ", validation: /^(\+?255|0)?[67]\d{8}$/ },
  { locale: "en-UG", iso2: "UG", validation: /^(\+?256|0)?[7]\d{8}$/ },
  { locale: "en-US", iso2: "US", validation: /^((\+1|1)?( |-)?)?(\([2-9][0-9]{2}\)|[2-9][0-9]{2})( |-)?([2-9][0-9]{2}( |-)?[0-9]{4})$/ },
  ...
  { locale: "es-EC", iso2: "EC", validation: /^(\+?593|0)([2-7]|9[2-9])\d{7}$/ },
  { locale: "es-ES", iso2: "ES", validation: /^(\+?34)?(6\d{1}|7[1234])\d{7}$/ },
  ...
  { locale: "et-EE", iso2: "EE", validation: /^(\+?372)?\s?(5|8[1-4])\s?([0-9]\s?){6,7}$/ },
  { locale: "fa-IR", iso2: "IR", validation: /^(\+?98[\-\s]?|0)9[0-39]\d[\-\s]?\d{3}[\-\s]?\d{4}$/ },
  { locale: "fi-FI", iso2: "FI", validation: /^(\+?358|0)\s?(4(0|1|2|4|5|6)?|50)\s?(\d\s?){4,8}\d$/ },
  { locale: "fj-FJ", iso2: "FJ", validation: /^(\+?679)?\s?\d{3}\s?\d{4}$/ },
  { locale: "fo-FO", iso2: "FO", validation: /^(\+?298)?\s?\d{2}\s?\d{2}\s?\d{2}$/ },
  ...
  { locale: "he-IL", iso2: "IL", validation: /^(\+972|0)([23489]|5[012345689]|77)[1-9]\d{6}$/ },
  { locale: "hu-HU", iso2: "HU", validation: /^(\+?36)(20|30|70)\d{7}$/ },
  { locale: "id-ID", iso2: "ID", validation: /^(\+?62|0)8(1[123456789]|2[1238]|3[1238]|5[12356789]|7[78]|9[56789]|8[123456789])([\s?|\d]{5,11})$/ },
  { locale: "it-IT", iso2: "IT", validation: /^(\+?39)?\s?3\d{2} ?\d{6,7}$/ },
  { locale: "ja-JP", iso2: "JP", validation: /^(\+81[ \-]?(\(0\))?|0)[6789]0[ \-]?\d{4}[ \-]?\d{4}$/ },
  { locale: "kk-KZ", iso2: "KZ", validation: /^(\+?7|8)?7\d{9}$/ },
  { locale: "kl-GL", iso2: "GL", validation: /^(\+?299)?\s?\d{2}\s?\d{2}\s?\d{2}$/ },
  { locale: "ko-KR", iso2: "KR", validation: /^((\+?82)[ \-]?)?0?1([0|1|6|7|8|9]{1})[ \-]?\d{3,4}[ \-]?\d{4}$/ },
  { locale: "lt-LT", iso2: "LT", validation: /^(\+370|8)\d{8}$/ },
  { locale: "ms-MY", iso2: "MY", validation: /^(\+?6?01){1}(([0145]{1}(\-|\s)?\d{7,8})|([236789]{1}(\s|\-)?\d{7}))$/ },
  ...
  { locale: "pl-PL", iso2: "PL", validation: /^(\+?48)? ?[5-8]\d ?\d{3} ?\d{2} ?\d{2}$/ },
  {
    locale: "pt-BR",
    isoBR2: "",
    phoneCodes: [],
    validation: /(?=^(\+?5{2}\-?|0)[1-9]{2}\-?\d{4}\-?\d{4}$)(^(\+?5{2}\-?|0)[1-9]{2}\-?[6-9]{1}\d{3}\-?\d{4}$)|(^(\+?5{2}\-?|0)[1-9]{2}\-?9[6-9]{1}\d{3}\-?\d{4}$)/,
  },
  { locale: "pt-PT", iso2: "PT", validation: /^(\+?351)?9[1236]\d{7}$/ },
  { locale: "ro-RO", iso2: "RO", validation: /^(\+?4?0)\s?7\d{2}(\/|\s|\.|\-)?\d{3}(\s|\.|\-)?\d{3}$/ },
  { locale: "ru-RU", iso2: "RU", validation: /^(\+?7|8)?9\d{9}$/ },
  { locale: "sl-SI", iso2: "SI", validation: /^(\+386\s?|0)(\d{1}\s?\d{3}\s?\d{2}\s?\d{2}|\d{2}\s?\d{3}\s?\d{3})$/ },
  { locale: "sk-SK", iso2: "SK", validation: /^(\+?421)? ?[1-9][0-9]{2} ?[0-9]{3} ?[0-9]{3}$/ },
  { locale: "sr-RS", iso2: "RS", validation: /^(\+3816|06)[- \d]{5,9}$/ },
  { locale: "sv-SE", iso2: "SE", validation: /^(\+?46|0)[\s\-]?7[\s\-]?[02369]([\s\-]?\d){7}$/ },
  ...
  { locale: "vi-VN", iso2: "VN", validation: /^(\+?84|0)((3([2-9]))|(5([2689]))|(7([0|6-9]))|(8([1-6|89]))|(9([0-9])))([0-9]{7})$/ },
  { locale: "zh-CN", iso2: "CN", validation: /^((\+|00)86)?1([358][0-9]|4[579]|6[67]|7[01235678]|9[189])[0-9]{8}$/ },
