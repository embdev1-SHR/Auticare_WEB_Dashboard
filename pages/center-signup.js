...
import CenterSignupForm from "../components/center-management/center-signup-form.component";
...
function CenterSignup() {
  ...
  return (
    <div>
      <Head>
        <meta property="og:title" content="Auticare - Center Registration" />
        <meta property="og:url" content="/center-signup" />
      </Head>
              ...
              <div className="w-100 h-100 justify-content-center">
                <div className="d-flex flex-column auth_flex h-100">
                  ...
                  <div className="auth_body p-5 d-flex pb-5 flex-column justify-content-center">
                    <h4 className="font-size-20">Center Registration</h4>
                    <p className="text-muted">Register your center. An admin will review and activate your account.</p>
