...
import { CreateFreeResources, ResourceIsLoading } from "../../store/slice/resource.slice";
...
function AddMedia() {
  ...
  const onSubmit = async (values) => {
    ...
    dispatch(CreateFreeResources(valueToSend));
  };
      ...
      <Formik initialValues={{
        ...
        {({ touched, errors, handleSubmit, resetForm, isSubmitting, setFieldValue, values }) => (
          <Modal
            ...
            <ModalFooter>
              <Button type='submit' disabled={loading} color='primary' className='btn-md m-1 waves-effect waves-light action_btn' onClick={handleSubmit} >
                Submit
              </Button>
            </ModalFooter>
          </Modal>
